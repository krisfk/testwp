...
class PostMetaExistsEntity extends PostMetaNumEntity
{
    ...
    public function addTermsToWpQuery( $queried_value, $wp_query )
    {
        ...
        // If this is NOT EXISTS query type relation should be AND NOT IN
//        if( $wp_query->get('wc_query') === 'product_query' ){
//            $flrt_filtered_query = [];
//            if( $wp_query->get('flrt_filtered_query') ){
//                $flrt_filtered_query = $wp_query->get('flrt_filtered_query');
//            }
//
//            $flrt_filtered_query[] =  $this->new_meta_query;
//
//            $wp_query->set('flrt_filtered_query', $this->new_meta_query );
//        }
